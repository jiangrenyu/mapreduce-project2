...
/**
 * Created by johen on 2016/7/20.
 */
public class NewFileOutputCommitter extends OutputCommitter {
     ...
     */
    @Deprecated
    protected  final String TEMP_DIR_NAME = PENDING_DIR_NAME;
     ...
     * @throws IOException
     */
    public NewFileOutputCommitter(Path outputPath,
    ...
    public NewFileOutputCommitter(Path outputPath,
        ...
        String  provId = ProvName2Code.getProvCode(conf.get("provIdNameOrCode"));
        String  dataDate = conf.get("runDataDate");
        String  runHours = conf.get("runHours");
        PENDING_DIR_NAME=provId+"_"+dataDate+"_"+runHours+"_temporary";
        algorithmVersion =
    ...
    private FileStatus[] getAllCommittedTaskPaths(JobContext context)
        ...
        return fs.listStatus(jobAttemptPath, new NewFileOutputCommitter.CommittedTaskFilter());
    }
